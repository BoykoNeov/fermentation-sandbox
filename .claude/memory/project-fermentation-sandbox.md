...
- **The JOINT repair, blend + growth sink (D-266)** — RUN for the first time; neither refusal had measured
  ...
  tracer INSIDE Rollero's band (the pre-registered "pays on the tracer" was WRONG); isoamyl on Crépin's must
