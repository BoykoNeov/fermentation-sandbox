...
## Status (2026-08-26)
M0/M1/M2 **complete**. **M3** (sensory/OAV + Tier-3 aging, D-66) at **D-230** (D-231 is tooling, not model); sensory 1a/1b + **D-139's leftovers ALL closed** (D-148/9). Suite **1867 + 5 xfail** (3 D-188 Herzan; 2 D-215's own) — COLLECTED, not carried: the ledger read 1861 for two beats.
