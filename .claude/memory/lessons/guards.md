...
- [A defect pin can outlive its defect](../feedback-a-defect-pin-can-outlive-its-defect-by-driving-another-path.md) — the "a RED means it was fixed" pin stayed GREEN through its own repair: its arms drove a hand-wired path the fix does not sit on. Trace the path before reading the colour (D-236)
