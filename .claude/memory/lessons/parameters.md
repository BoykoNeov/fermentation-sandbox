...
- [A saturating knob cannot be the repair](../feedback-a-saturating-knob-cannot-be-the-repair.md) — "extent insensitive, timing misses" read as a repair still available; swept to 1000x the timing SATURATES. `rate ∝ X` can't outrun X. Unreachable, not deferred — and the shape is what's wrong (D-249)
