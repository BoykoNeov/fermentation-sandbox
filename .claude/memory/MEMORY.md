...
- [Project: Fermentation Sandbox](project-fermentation-sandbox.md) — status + repo; M0/M1 done, M2 in progress at D-37 (481 green); full decision log in docs/DECISIONS.md
