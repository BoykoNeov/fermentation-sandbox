...
- [Project: Fermentation Sandbox](project-fermentation-sandbox.md) — status + repo; M0/M1/M2 complete, Milestone-3/Tier-3 aging in progress at D-111. Per-decision archive: docs/DECISIONS.md
