...
- [**D-29**](#d-29--hydrogen-sulfide-h₂s-a-carbon-free-produced-pool-with-an-inverse-nitrogen-gate) — Hydrogen sulfide (H₂S): a carbon-free produced pool with an inverse-nitrogen gate
...
- [**D-42**](#d-42--h₂s-co₂-stripping-sink-hydrogensulfidevolatilization-residual-vs-cumulative-produced) — H₂S CO₂-stripping sink (`HydrogenSulfideVolatilization`): residual vs cumulative produced
...
- [**D-44**](#d-44--post-fermentation--autolytic-h₂s-source--copper-fining-the-two-d-42-deferred-items) — Post-fermentation / autolytic H₂S source + copper fining (the two D-42 deferred items)
...
- [**D-75**](#d-75--streckerdegradation-built-the-o₂amino-acid-strecker-aldehydes-cooked-potato--honey-a-wine-only-substrate-gated-sink-41) — `StreckerDegradation` built: the O₂/amino-acid Strecker aldehydes (cooked-potato + honey), a …
...
- [**D-81**](#d-81--anthocyaninfading-built--polymeric-pigment-promoted-to-a-slot-the-so₂ph-anthocyanin-bleaching-beat--color_series-now-genuinely-declines-and-so₂-colour-protection-is-emergent-41) — `AnthocyaninFading` built + polymeric pigment PROMOTED to a slot: the SO₂/pH anthocyanin-bleaching …
- [**D-82**](#d-82--observed_color_series-built-the-reversible-so₂ph-masking-readout--beat-a-so-the-colour-axiss-both-request-is-now-complete-41) — `observed_color_series` built: the reversible SO₂/pH **masking** readout — beat A, so the colour …
